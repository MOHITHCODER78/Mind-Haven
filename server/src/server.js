...
// Trust exactly one proxy (Render's load balancer) for proper IP forwarding
// This is secure because we explicitly trust only the known proxy, not all proxies
